              ...
              <Table>
                <TableHeader className="bg-muted/50 sticky top-0 z-20">
                  <TableRow className="hover:bg-transparent">
                    ...
                    <TableHead className="text-xs font-bold uppercase tracking-wider h-11">Master Name</TableHead>
                      ...
                      <TableRow key={item._id} className="hover:bg-muted/30 group transition-colors">
                        <TableCell className="text-xs text-muted-foreground">
                          {formatDate(isChallan 
                            ...
                            : (item.challanDate || item.createdAt))}
                        </TableCell>
                        ...
                        <TableCell className="text-xs font-semibold">
                          {item.qualityName || item.quality || "-"}
                        </TableCell>
                        <TableCell className="text-right font-semibold">
                          {item.taka || item.totalTaka || 0}
                        </TableCell>
                        <TableCell className="text-right font-bold text-primary">
                          {Number(item.meter || item.totalMeter || 0).toFixed(1)}m
                        </TableCell>
